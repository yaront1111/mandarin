 ...
 * Core client that handles connection, authentication, and event infrastructure
 */
class SocketClient {
  constructor() {
    this.socket = null;
  ...
  _setupSocketHandlers() {
    ...
    this._registerEventForwarder("messageReceived");
    this._registerEventForwarder("messageSent");
    this._registerEventForwarder("messageError");
    this._registerEventForwarder("userTyping");

    // Register event forwarders for call events
    this._registerEventForwarder("videoSignal");
    this._registerEventForwarder("videoHangup");
    this._registerEventForwarder("videoError");
    this._registerEventForwarder("videoMediaControl");
    this._registerEventForwarder("incomingCall");
    this._registerEventForwarder("callAnswered");
    this._registerEventForwarder("callInitiated");
    this._registerEventForwarder("callError");

    // User events
    this._registerEventForwarder("userOnline");
    this._registerEventForwarder("userOffline");
  }

  /**
   * Helper method to register an event forwarder
   * @param {string} eventName - Event name to forward
   */
  _registerEventForwarder(eventName) {
