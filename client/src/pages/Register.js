...
import {
  ...
  FaArrowRight, FaArrowLeft, FaGoogle, FaFacebook, FaExclamationTriangle
} from 'react-icons/fa';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare registration data, ensuring proper format
    const registrationData = {
      ...
      details: {
        ...
        interests: [...formData.interests], // Ensure array copy
        lookingFor: [...formData.lookingFor] // Ensure array copy
      }
    };
  ...
  const renderStep1 = () => (
    <>
      ...
      <div className="form-group">
        ...
        {formErrors.nickname ? (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.nickname}
          </p>
        ) : (
      ...
      <div className="form-group">
        ...
        {formErrors.email ? (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.email}
          </p>
        ) : (
      ...
      <div className="form-group">
        ...
        {formErrors.password ? (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.password}
          </p>
        ) : (
      ...
      <div className="form-group">
        ...
        {formErrors.confirmPassword && (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.confirmPassword}
          </p>
        )}
      </div>
  ...
  const renderStep2 = () => (
    <>
      ...
      <div className="form-group">
        ...
        {formErrors.age ? (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.age}
          </p>
        ) : (
      ...
      <div className="form-group">
        ...
        <div className="d-flex gap-2">
          <label className={`gender-option ${formData.gender === 'Male' ? 'selected' : ''} ${formErrors.gender ? 'error' : ''}`}>
            <input
              type="radio"
              name="gender"
              value="Male"
          ...
          <label className={`gender-option ${formData.gender === 'Female' ? 'selected' : ''} ${formErrors.gender ? 'error' : ''}`}>
            <input
              type="radio"
              name="gender"
              value="Female"
          ...
          <label className={`gender-option ${formData.gender === 'Other' ? 'selected' : ''} ${formErrors.gender ? 'error' : ''}`}>
            <input
              type="radio"
              name="gender"
              value="Other"
        ...
        {formErrors.gender && (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.gender}
          </p>
        )}
      </div>
      <div className="form-group">
        ...
        {formErrors.location ? (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.location}
          </p>
        ) : (
    ...
    <>
      ...
      <div className="form-group">
        ...
        {formErrors.interests && (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.interests}
          </p>
        )}
      </div>
      <div className="form-group">
        ...
        {formErrors.lookingFor && (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.lookingFor}
          </p>
        )}
      </div>
      <div className="form-group checkbox-group mt-3">
        ...
        {formErrors.agreeTerms && (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.agreeTerms}
          </p>
        )}
      </div>
      <div className="form-group checkbox-group">
        <label className={`checkbox-label ${formErrors.agreePrivacy ? 'error' : ''}`}>
          ...
          />
          <span style={{ marginLeft: '8px' }}>
            I agree to the <Link to="/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</Link>
          </span>
        </label>
        {formErrors.agreePrivacy && (
          <p className="error-message text-danger">
            <FaExclamationTriangle className="me-1" />{formErrors.agreePrivacy}
          </p>
        )}
      </div>
      <div className="form-group checkbox-group">
