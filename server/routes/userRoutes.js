...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      // --- Use Like model directly ---
      // const db = mongoose.connection
      // const likesCollection = db.collection("likes")
      // const likesQuery = [ ... ] // Aggregation pipeline was complex
      // const totalQuery = [ ... ]
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      // --- POTENTIAL ISSUE 1: Socket Notification ---
      // This function `sendLikeNotification` is imported from handlers.js
